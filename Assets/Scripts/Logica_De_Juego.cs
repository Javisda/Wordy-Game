...
// Classes for the JSON local database
[System.Serializable]
public class Word
{
    public string word;
...
public class Logica_De_Juego : MonoBehaviour
{
    // Primer intento
    ...
    /*public void CheckWord() 
    {
        ...
        if (palabraValida)
        {
            ...
            if (palabra1final.Length == 5 && numIntento == 1)
            {
                ...
                // Amarilla
                else if (hiddenWord.Contains(intento1letra1.text))
                {
                ...
                // Amarilla
                else if (hiddenWord.Contains(intento1letra2.text))
                {
                ...
                // Amarilla
                else if (hiddenWord.Contains(intento1letra3.text))
                {
                ...
                // Amarilla
                else if (hiddenWord.Contains(intento1letra4.text))
                {
                ...
                // Amarilla
                else if (hiddenWord.Contains(intento1letra5.text))
                {
            ...
            if (palabra2final.Length == 5 && numIntento == 2)
            {
                ...
                // Amarilla
                else if (hiddenWord.Contains(intento2letra1.text))
                {
                ...
                // Amarilla
                else if (hiddenWord.Contains(intento2letra2.text))
                {
                ...
                // Amarilla
                else if (hiddenWord.Contains(intento2letra3.text))
                {
                ...
                // Amarilla
                else if (hiddenWord.Contains(intento2letra4.text))
                {
                ...
                // Amarilla
                else if (hiddenWord.Contains(intento2letra5.text))
                {
            ...
            if (palabra3final.Length == 5 && numIntento == 3)
            {
                ...
                // Amarilla
                else if (hiddenWord.Contains(intento3letra1.text))
                {
                ...
                // Amarilla
                else if (hiddenWord.Contains(intento3letra2.text))
                {
                ...
                // Amarilla
                else if (hiddenWord.Contains(intento3letra3.text))
                {
                ...
                // Amarilla
                else if (hiddenWord.Contains(intento3letra4.text))
                {
                ...
                // Amarilla
                else if (hiddenWord.Contains(intento3letra5.text))
                {
            ...
            if (palabra4final.Length == 5 && numIntento == 4)
            {
                ...
                // Amarilla
                else if (hiddenWord.Contains(intento4letra1.text))
                {
                ...
                // Amarilla
                else if (hiddenWord.Contains(intento4letra2.text))
                {
                ...
                // Amarilla
                else if (hiddenWord.Contains(intento4letra3.text))
                {
                ...
                // Amarilla
                else if (hiddenWord.Contains(intento4letra4.text))
                {
                ...
                // Amarilla
                else if (hiddenWord.Contains(intento4letra5.text))
                {
            ...
            if (palabra5final.Length == 5 && numIntento == 5)
            {
                ...
                // Amarilla
                else if (hiddenWord.Contains(intento5letra1.text))
                {
                ...
                // Amarilla
                else if (hiddenWord.Contains(intento5letra2.text))
                {
                ...
                // Amarilla
                else if (hiddenWord.Contains(intento5letra3.text))
                {
                ...
                // Amarilla
                else if (hiddenWord.Contains(intento5letra4.text))
                {
                ...
                // Amarilla
                else if (hiddenWord.Contains(intento5letra5.text))
                {
            ...
            if (palabra6final.Length == 5 && numIntento == 6)
            {
                ...
                // Amarilla
                else if (hiddenWord.Contains(intento6letra1.text))
                {
                ...
                // Amarilla
                else if (hiddenWord.Contains(intento6letra2.text))
                {
                ...
                // Amarilla
                else if (hiddenWord.Contains(intento6letra3.text))
                {
                ...
                // Amarilla
                else if (hiddenWord.Contains(intento6letra4.text))
                {
                ...
                // Amarilla
                else if (hiddenWord.Contains(intento6letra5.text))
                {
